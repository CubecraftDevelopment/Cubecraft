...
public class SimplexNoise extends Synth {
     ...
     */
     ...
     public static final int[] perm= { 151,160,137,91,90,15,
    ...
    public SimplexNoise(Random random) {
        ...
        {
            int nextNum = random.nextInt(255);
            perm[it] = (byte)nextNum;
            perm[it + 256] = (byte)nextNum;
        }
    }

    public static final double F2 = 0.366025403f;    // F2 = 0.5*(sqrt(3.0)-1.0)
    public static final double G2 = 0.211324865f;                    // G2 = (3.0-Math.sqrt(3.0))/6.0
