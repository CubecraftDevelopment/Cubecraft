...
import io.flybird.cubecraft.internal.network.packet.PacketType;
...
public class PacketChunkSection implements Packet {
    ...
    public void writePacketData(ByteBuf buffer) throws Exception {
        ...
        NBTBuilder.write(this.data, new DataOutputStream(g));
        g.close();
    ...
    public void readPacketData(ByteBuf buffer) throws Exception {
        ...
        this.data = (NBTTagCompound) NBTBuilder.read(new DataInputStream(in));
    }
