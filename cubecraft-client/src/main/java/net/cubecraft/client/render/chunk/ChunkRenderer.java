...
public final class ChunkRenderer extends IWorldRenderer {
    ...
    public void checkForAdd() {
        ...
        for (int i = cache.size()-1; i >= 0; i--) {
            ...
            setUpdate(pos.getX(), pos.getY(), pos.getZ());
        }
    }
    ...
    public Boolean chunkRemove(RenderChunkPos pos) {
        int dist = ClientSettingRegistry.CHUNK_RENDER_DISTANCE.getValue() * 16;
    ...
    private void updateRenderer() {
        ...
        try {
            ...
            this.posCache.removeIf(s -> chunkRemove(new RenderChunkPos(s)));
