...
public class ScrollPanel extends Node {
    ...
    public void render(float interpolationTime) {
        ...
        int sx = this.layout.getAbsoluteX() * scale;
        int i = this.context.getWindow().getHeight();
        int i2 = this.layout.getAbsoluteY() * scale;
        int sy = i - i2 - this.layout.getAbsoluteHeight() * scale;
        int sw = this.layout.getAbsoluteWidth() * scale;
        int sh = this.layout.getAbsoluteHeight() * scale;
