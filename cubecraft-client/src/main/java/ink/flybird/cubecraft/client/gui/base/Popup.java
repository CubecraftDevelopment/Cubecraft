...
public class Popup {
    ...
    public void render(){
        ...
        ClientSharedContext.SMOOTH_FONT_RENDERER.render(title,40,12,0xffffff,12,0, FontAlignment.LEFT);
        ClientSharedContext.SMOOTH_FONT_RENDERER.render(subTitle,40,28,0xffffff,8,0, FontAlignment.LEFT);
    }
