...
import io.flybird.cubecraft.level.LevelInfoFactory;
import io.flybird.cubecraft.server.net.RakNetServerIO;
import io.flybird.cubecraft.server.net.ServerIO;
import io.flybird.cubecraft.server.service.ServiceManager;
import io.flybird.cubecraft.server.world.ServerWorldFactory;
...
public class CubecraftServer extends LoopTickingThread {
    ...
    //private final GameSetting setting = new GameSetting(EnvironmentPath.CONFIG_FOLDER + "/server_setting.properties");
    private final ExecutorService worldTickingService = Executors.newFixedThreadPool(4);
