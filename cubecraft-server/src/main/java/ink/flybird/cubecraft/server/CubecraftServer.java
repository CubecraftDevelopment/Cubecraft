...
public class CubecraftServer extends LoopTickingThread {
    ...
    public void init() {
        ...
        this.status = ink.flybird.cubecraft.server.ServerStatus.STARTUP;
        ...
        this.status = ink.flybird.cubecraft.server.ServerStatus.RUNNING;
    }
    ...
    public void stop() {
        ...
        this.status = ink.flybird.cubecraft.server.ServerStatus.STOPPING;
